...
namespace Master.Migrations
{
    ...
    [Migration("20190513081758_MES_QuoteChooser")]
    partial class MES_QuoteChooser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Master.MES.Equipment", b =>
                {
                    ...
                    b.Property<decimal?>("DayCapacity");
            ...
            modelBuilder.Entity("Master.MES.EquipmentOperatorHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("EquipmentTransitionType");
                    ...
                    b.ToTable("EquipmentOperatorHistory");
                });
            ...
            modelBuilder.Entity("Master.MES.ProcessQuote", b =>
                {
                    ...
                    b.Property<int>("QuotePayType");

                    b.Property<string>("QuoteSN");

                    b.Property<int>("QuoteScope");
            ...
            modelBuilder.Entity("Master.MES.ProcessQuoteBid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ProcessQuoteBid");
                });

            modelBuilder.Entity("Master.MES.ProcessQuoteTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Master.MES.ProcessTask", b =>
                {
                    ...
                    b.Property<DateTime?>("ArrangeEndDate");
                    ...
                    b.Property<decimal?>("ToTenantEstimateHours");
            ...
            modelBuilder.Entity("Master.MES.Equipment", b =>
                {
                    b.HasOne("Master.Authentication.User", "Arranger")
                        .WithMany()
                    ...
                    b.HasOne("Master.Authentication.User", "Operator")
                        .WithMany()
                        .HasForeignKey("OperatorId");

                    b.HasOne("Master.Authentication.User", "Programmer")
                        .WithMany()
            ...
            modelBuilder.Entity("Master.MES.ProcessQuote", b =>
                {
                    b.HasOne("Master.Authentication.User", "ChooseUser")
                        .WithMany()
                        .HasForeignKey("ChooseUserId");
            ...
            modelBuilder.Entity("Master.MES.ProcessQuoteBid", b =>
                {
                    ...
                    b.HasOne("Master.MES.ProcessQuote", "ProcessQuote")
                        .WithMany("ProcessQuoteBids")
                    ...
                    b.HasOne("Master.MultiTenancy.Tenant", "ToTenant")
                        .WithMany()
