...
namespace Master.Migrations
{
    ...
    [Migration("20190524124907_CaseInitial")]
    partial class CaseInitial
    {
            ...
            modelBuilder.Entity("Master.Case.CaseInitial", b =>
                {
                    ...
                    b.Property<int>("JiuFenLeiXingId");

                    b.Property<int>("JiuFenYuanYinId");
                    ...
                    b.HasIndex("JiuFenLeiXingId");

                    b.HasIndex("JiuFenYuanYinId");

                    b.HasIndex("LastModifierUserId");

                    b.HasIndex("PanJueJieGuoId");

                    b.HasIndex("TenantId");

                    b.HasIndex("ZhuanTiId");
            ...
            modelBuilder.Entity("Master.Case.CaseInitial", b =>
                {
                    ...
                    b.HasOne("Master.Entity.BaseTree", "JiuFenLeiXing")
                        .WithMany()
                        .HasForeignKey("JiuFenLeiXingId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Master.Entity.BaseTree", "JiuFenYuanYin")
                        .WithMany()
                        .HasForeignKey("JiuFenYuanYinId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("Master.Entity.BaseTree", "PanJueJieGuo")
                        .WithMany()
                        .HasForeignKey("PanJueJieGuoId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("Master.Entity.BaseTree", "ZhuanTi")
                        .WithMany()
                        .HasForeignKey("ZhuanTiId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
