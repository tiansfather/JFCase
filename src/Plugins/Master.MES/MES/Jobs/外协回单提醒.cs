...
{
    public class OuterTaskReturnWeiXinMessageJob : BackgroundJob<SendWeiXinMessageJobArgs>, ITransientDependency
    {
        private IHostingEnvironment _hostingEnvironment;
        public RemindLogManager RemindLogManager { get; set; }
        public ProcessTaskManager ProcessTaskManager { get; set; }
        public OuterTaskReturnWeiXinMessageJob(IHostingEnvironment hostingEnvironment)
        {
